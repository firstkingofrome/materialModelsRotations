...
x_vel_all = sw4essiout['vel_1 ijk layout'][:, x_slice_start:x_slice_end, y_slice_start:y_slice_end, z_slice_start:z_slice_end]
y_vel_all = sw4essiout['vel_0 ijk layout'][:, x_slice_start:x_slice_end, y_slice_start:y_slice_end, z_slice_start:z_slice_end]
...
for i in range(start, nt-1):
    ...
    prev_x_vel =  x_vel_all[i-1, :, :, :]
    prev_y_vel =  y_vel_all[i-1, :, :, :]
    prev_z_vel = -z_vel_all[i-1, :, :, :]

    next_x_vel =  x_vel_all[i+1,  :, :, :]
    next_y_vel =  y_vel_all[i+1, :, :, :]
    next_z_vel = -z_vel_all[i+1,  :, :, :]
